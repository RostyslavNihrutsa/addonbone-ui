...
const variants: (IconButtonVariant | 'default')[] = ['default', IconButtonVariant.Contained, IconButtonVariant.Outlined, IconButtonVariant.Ghost]
const sizes: (IconButtonSize | 'default')[] = [IconButtonSize.Small, 'default', IconButtonSize.Medium, IconButtonSize.Large]
const radius: (IconButtonRadius | 'default')[] = [IconButtonRadius.Small, IconButtonRadius.Medium, IconButtonRadius.Large, 'default']
